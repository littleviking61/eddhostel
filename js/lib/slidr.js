    ...
    auto: function(_, msec, direction) {
      if (_.started && slides.isdir(direction)) {
        ...
        _.auto.id = setInterval(function() {
          // to have continious sliding
          if (!(_.settings['pause'] && nav.mouse.isOver(_.id))) {
            if(_.current == Object.keys(_.slides).length || (_.current == 1 && direction == 'left') ) {
                _.auto.direction = _.auto.direction  ==  'left' ? _.auto.direction = 'right' : _.auto.direction = 'left';
