...
if (function_exists('add_theme_support'))
{
    ...
    add_image_size('portrait', 675, 900, array('left', 'top')); // Portrait
...
function html5blank_header_scripts()
{
    if ($GLOBALS['pagenow'] != 'wp-login.php' && !is_admin()) {
        if (HTML5_DEBUG) {
            ...
            wp_register_script('jquery', get_template_directory_uri() . '/js/lib/jquery-3.2.1.min.js', array(), '1.11.1');

            // Conditionizr
            wp_register_script('conditionizr', get_template_directory_uri() . '/js/lib/conditionizr.min.js', array(), '4.3.0');
...
?>
    ...
    <div class="reply">
        <i class="eddicon-reply"></i> <?php comment_reply_link(array_merge( $args, array('add_below' => $add_below, 'depth' => $depth, 'max_depth' => $args['max_depth']))) ?>
    </div>
    <?php if ( 'div' != $args['style'] ) : ?>
      </div>
    <?php endif; ?>
